...
#elif 0 // susfs SUS_SU was deprecated/removed since SUSFS v2.0.0 and no
        // longer provides these hooks, so this branch is disabled and we
        // fall through to the manual-hook implementation below instead.
